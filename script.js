...
gif.addEventListener('click', ()=> {
    ...
    if(contarClick >= maxClick){
        ...
        window.location.href = 'https://aldairf1.github.io/lamp/';
    }
})
...
// Variable para evitar iniciar la animación varias veces
let animationStarted = false;

// Oculta el canvas por defecto
canvas.style.display = 'none';

// Función para alternar visibilidad
toggleButton.addEventListener('click', () => {
    const isCountdownVisible = countdownSection.style.display !== 'none';

    if (isCountdownVisible) {
        // Ocultar cuenta regresiva y contador
    ...
    //    toggleButton.textContent = 'Mostrar Cuenta Regresiva';
    ...
    // } else {
    //     // Mostrar cuenta regresiva y contador
    ...
    //     // Ocultar el canvas
    //     canvas.style.display = 'none';
    //     toggleButton.textContent = 'Mostrar Happy Birthday';
    }
});
